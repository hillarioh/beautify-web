...
function LoggedHome({ type }) {
  let match = useRouteMatch();
  return (
    <>
      <Switch>
        {type === "client" ? (
          <Route path={`${match.path}/profile`} component={Client} />
        ) : (
          <Route path={`${match.path}/profile`} component={ServiceProvider} />
        )}
    ...
    <div className="logged-page">
      ...
      <nav>
        ...
        <div className="log-status">
          <Link className="mark" to={`${match.url}/profile`}>
            <span></span>
          </Link>
          <div>
            <span>Welcome</span>
